...
public class UploadDownloadFile {
	 ...
	 * @throws Exception
	 */
	public static String download(HttpServletResponse response, String path, String fileName) throws Exception {
	...
	public static String download(HttpServletResponse response, String path) throws Exception {
	...
	public static String[] uploadfiles(MultipartFile[] files, String realPath) {
		/*
